...
\begin{frame}
  \frametitle{Code sharing}
  Can be problems with longevity (esp. personal webpages).

  Still a role for long term static archives:
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Many journals now on-board
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  Primary data is \emph{usually} shared, now expected:
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Your GitHub (etc) profile can be part of your CV, e.g.
      \begin{itemize}
        \item \href{https://github.com/peterjc}{Peter's GitHub profile}
        \item \href{https://bitbucket.org/peterjc/}{Peter's BitBucket profile}
        \item \href{https://gitlab.com/pjacock}{Peter's GitLab profile}
        \item \href{https://www.biostars.org/u/146/}{Peter's BioStars profile}
      \end{itemize}
 \end{itemize}
\end{frame}
